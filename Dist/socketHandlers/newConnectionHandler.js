...
const serverStore = __importStar(require("../serverStore"));
const newConnectionHandler = (socket, io) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // updateFriendsPendingInvitations(userDetail.userId);
    // updateFriends(userDetail.userId);
    // addNewConnectedUser : 파라미터 전달하여 Map 함수 호출하여 생성후 set 메소드에 인자값 넣어 저장
});
exports.newConnectionHandler = newConnectionHandler;
//# sourceMappingURL=newConnectionHandler.js.map